...
public class CodeUtil {
    ...
    public static byte[] hexStr2Bytes(String hexStr) {
        return HexUtil.decodeHex(hexStr.toCharArray());
    }
    ...
    public static byte[] generateSimilarNodeId(byte[] hash, int num) {
        ...
        //拷贝随机数组到后num位
        System.arraycopy(RandomUtil.simpleNextBytes(num),0,result,hash.length - num,num);
        return result;
    }
    ...
    public static String generateSimilarInfoHashString(byte[] nodeId,int num) {
        return new String(generateSimilarNodeId(nodeId,num), StandardCharsets.ISO_8859_1);
    }
    ...
    public static String stringToMd5(String str) {
        return DigestUtil.md5Hex(str.getBytes());
    }
